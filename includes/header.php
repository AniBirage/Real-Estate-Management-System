        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><img src="http://localhost/homeland/admin-panel/properties-admins/thumbnails/logo.jpg" alt="Image" class="img-fluid" width="125" height="125"><a href="<?php echo APPURL; ?>" class="text-white h2 mb-0"><strong>EagleEstate</strong></a></h1>
            </div>
